export const experienceData = [
    ...
    {
      period: "",
      title: "My experience will be here 🙂",
      name: "",
      text: "",
      responsibilities: [
        "",
